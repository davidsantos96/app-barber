// Template para configuração de usuários
// IMPORTANTE: Este é um arquivo de template. 
// Copie para 'userData.ts' e configure com as credenciais reais.
...
export const USERS: User[] = [
  {
    id: 'user-1',
    username: 'admin',
    password: 'CONFIGURE_SENHA_ADMIN',
    name: 'Administrador',
    role: 'admin',
  ...
  },
  {
    ...
    password: 'CONFIGURE_SENHA',
    name: 'CONFIGURE_NOME_BARBEIRO',
    role: 'barbeiro',
    barbearia: 'CONFIGURE_NOME_BARBEARIA'
  },
  {
    id: 'user-4',
    username: 'CONFIGURE_USERNAME_2', 
    password: 'CONFIGURE_SENHA_2',
    name: 'CONFIGURE_NOME_BARBEIRO_2',
    role: 'barbeiro',
    barbearia: 'CONFIGURE_NOME_BARBEARIA_2'
  }
];
...
export const USER_DATA = {
  ...
  'user-3': {
    clientes: [
      // Configure aqui os clientes do primeiro barbeiro
    ],
    agendamentos: [
      // Configure aqui os agendamentos do primeiro barbeiro
    ]
  },
  'user-4': {
    clientes: [],
